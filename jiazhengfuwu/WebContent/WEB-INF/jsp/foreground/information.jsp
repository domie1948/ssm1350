...
<tr> 
    ...
    <tr> 
      ...
      <td> 
        <input type="text" name="age" value="${user['age'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    ...
    <tr> 
      ...
      <td> 
        <select name="sex">
			<c:if test="${user['sex'] eq 1}" var="s1">
				<option value="1" selected="selected">男</option>
			</c:if>
			<c:if test="${!s1}">
				<option value="1">男</option>
			</c:if>
			<c:if test="${user['sex'] eq 2}" var="s2">
    ...
    <tr> 
      <td width="80" align="right">服务类型：</td>
      <td> 
       <input type="text" name="flag" value="${user['flag'] }" class="input" style="width:200px" />
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    <tr> 
      <td width="80" align="right">身   份：</td>
      <td> 
        <select name="roleId">
        	<c:if test="${user['roleInfo']['id'] eq 2}" var="s3">
			<option value="2" selected="selected">雇员</option>
        	</c:if>
        	<c:if test="${!s3}">
			<option value="2">雇员</option>
        	</c:if>
        	<c:if test="${user['roleInfo']['id'] eq 3}" var="s4">
			<option value="3" selected="selected">雇主</option>     
		</c:if>
			<c:if test="${!s4}">
			<option value="3">雇主</option>     
		</c:if>   		
        </select>
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    <tr> 
      <td width="80" align="right">详细介绍：</td>
      <td> 
       <textarea rows="5" cols="80" name="remark">${user['remark'] }</textarea>
        <font style='color:red'>*</font> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
    <tr> 
