...
<div id="shopcontent">
<form method="post" id="user" action="bargain/informationAdd" onsubmit="return check();">
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <div class="piczone">
				...
				<td align="center">
				<div id="shopview">
					<img src="upload/upload/${user['url'] }" style="width: 174px;height: 241px;" border="0" id="shoploading" class="shoploading">
				</div>
				</td>
				</tr>
				</table>
          ...
          <td>
		  <div id="prodtitle">${user['userName'] } </div>
			<div id="prop">
				性别：
	...
	<div id="bodyzone" class="bodyzone"><p><font face=宋体 size=3>
				<c:if test="${sessionScope['User']['vip']['status'] eq 0}">
					您尚未成为会员,不能查看详细信息 &nbsp;<a href="request/rechargeAddFore">充值</a>
				</c:if>
				<c:if test="${sessionScope['User']['vip']['status'] eq 2}">
					您的会员已过期 &nbsp;<a href="request/rechargeAddFore">充值</a>
				</c:if>
				<c:if test="${sessionScope['User']['vip']['status'] eq 1}">
				姓名：${user['userName'] }<br />
				性别：
				<c:if test="${user['sex'] eq 1}">
				<c:out value="男" /><br />
