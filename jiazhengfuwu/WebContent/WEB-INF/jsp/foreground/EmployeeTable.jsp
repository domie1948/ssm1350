...
<div class="shopquery">
		<div class="fang" style="width:120px;height:120px">
			...
			<a href="user/employeeQueryOneFore?id=${user['id'] }" target="_self" ><img src="upload/upload/${user['url'] }" style="width:120px;height:120px" border="0" /></a>
			</div>
		</div>
		<div class="prop">
		姓名：<span class="hb"></span><span class="price">${user['userName'] }</span><br />
		</div>
		<div class="memo" >
		${user['flag'] }
		</div>
...
<div id="showpages" >
	  ...
	  <a href="user/employeeQueryFore?pageNow=${pager.pageNow }">上一页</a>
	  </c:if>
	   <c:if test="${!pagele}">
	  <a href="user/employeeQueryFore?pageNow=${pager.pageNow -1}">上一页</a>
	  </c:if>
	  </li>
	  <li class="pbutton">
	  <c:if test="${pager.pageNow ge pager.totalPages }" var="pagege">
	  <a href="user/employeeQueryFore?pageNow=${pager.pageNow }">
	  下一页
	  </a>
	  </c:if>
	  <c:if test="${!pagege }">
	  <a href="user/employeeQueryFore?pageNow=${pager.pageNow+1 }">
	  下一页
	  </a>
	  </c:if>
	  </li></ul></div>
