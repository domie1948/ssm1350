...
<table width="100%" border="0" cellspacing="0" cellpadding="3" >
	...
	<c:if test="${vip['status'] eq 0}" var="s1">
		<tr> 
      <td width="90" align="right">您不是会员：</td>
      <td> 
       	<a href="request/rechargeAddFore">充值</a>
    </tr>
	</c:if>
	<c:if test="${!s1 }">
    <tr> 
    ...
    <tr> 
      ...
      <td> 
        ...
        &nbsp;<a href="request/rechargeAddFore">续费</a> <div style="padding-top:3px;color:#666"></div> </td>
    </tr>
	<tr> 
