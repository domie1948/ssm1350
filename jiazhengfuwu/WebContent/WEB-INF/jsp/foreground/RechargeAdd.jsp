...
<form id="jobform" method="post" onsubmit="return Check();" action="recharge/informationAddFore" name="jobform">
<table width="100%" border="0" cellspacing="0" cellpadding="3" >


    <tr> 
      <td width="80" align="right">充值时长：</td>
      <td> 
        <select name="recharge_type">
        		<option value="1">一个月 ￥10</option>
        		<option value="2">三个月 ￥25</option>
        		<option value="3">半年 ￥50</option>
        		<option value="4">一年 ￥102</option>
        </select>
    ...
    <tr> 
      <td width="80" align="right">&nbsp;</td>
      <td height="30">
        <input type="submit" name="ccc" value="支付" class="submit">
