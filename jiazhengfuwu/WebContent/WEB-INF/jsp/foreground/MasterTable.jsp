...
<div class="shopquery">
		<div class="fang" style="width:120px;height:120px">
			...
			<a href="user/masterQueryOneFore?id=${user['id'] }" target="_self" ><img src="upload/upload/${user['url'] }" style="width:120px;height:120px" border="0" /></a>
			</div>
		</div>
		<div class="prop">
...
<div id="showpages" >
	  ...
	  <a href="user/masterQueryFore?pageNow=${pager.pageNow }">上一页</a>
	  </c:if>
	   <c:if test="${!pagele}">
	  <a href="user/masterQueryFore?pageNow=${pager.pageNow -1}">上一页</a>
	  </c:if>
	  </li>
	  <li class="pbutton">
	  <c:if test="${pager.pageNow ge pager.totalPages }" var="pagege">
	  <a href="user/masterQueryFore?pageNow=${pager.pageNow }">
	  下一页
	  </a>
	  </c:if>
	  <c:if test="${!pagege }">
	  <a href="user/masterQueryFore?pageNow=${pager.pageNow+1 }">
	  下一页
	  </a>
	  </c:if>
	  </li></ul></div>
